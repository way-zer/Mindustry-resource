...
export default defineStore("user", () => {
    ...
    const redirectPath = useLocalStorage<string | undefined>("redirect_path", undefined)
    ...
    return {
        ...
        async login<T extends keyof LoginMethods>(method: T, data: LoginMethods[T]) {
            if (!logged.value) {
                ...
                if (res.token !== undefined) {
                    ...
                    //register
                    ElMessage.info("账号不存在，可更换其他登录方式，或输入用户名注册新账号")
