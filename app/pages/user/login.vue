<template>
  <el-card class="container max-w-[400px] m-auto">
    ...
    <el-button class="w-full my-1" @click="store.oauthLogin('discord')">使用Discord继续</el-button>
    <br />
    <el-button class="w-full my-1" v-if="method != 'email'" @click="method = 'email'">使用QQ邮箱继续</el-button>
    <el-button class="w-full my-1" v-if="method != 'username'" @click="method = 'username'">老用户使用密码登录</el-button>
  </el-card>
</template>
