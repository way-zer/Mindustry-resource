<template>
  <el-card class="container max-w-[400px] m-auto">
    ...
    <el-button class="w-full my-1" size="large" @click="back(false)">继续登录</el-button>
    <el-divider>注册新用户</el-divider>
    ...
    <el-form ref="formRef" :model="form" size="large">
      <el-form-item prop="name" :rules="[
        ...
        <el-input v-model="form.name" placeholder="用户名" autocomplete="username" autofocus />
      </el-form-item>
      <el-button type="primary" class="w-full" @click="onSubmit">注册新用户</el-button>
    </el-form>
    <div class="mt-4">
      <el-button class="w-full my-1" text @click="back(true)">取消登录</el-button>
    </div>
  </el-card>
</template>
