<template>
  ...
  <client-only>
    <el-dialog :model-value="userStore.showDialog" :before-close="close" :title="isLogin?'登录':'注册'" center>
      <el-form ref="formRef" :model="form" @submit="submit">
        ...
        <el-form-item>
          ...
          <span v-if="isLogin">还没账号,点击<el-button link type="primary"
                                                       @click="isLogin=false">注册</el-button></span>
