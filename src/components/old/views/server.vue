<template>
  <el-card>
    ...
    <el-table :data="store.data">
      <el-table-column label="地址 (按版本筛选)" prop="address" fixed="left" :filters="versionFilters"
      ...
      <el-table-column label="地图 (按模式筛选)" prop="map" :filters="modeFilters" :filter-method="(f, v) => (v.mode === f)">
        <template #default="scope">
